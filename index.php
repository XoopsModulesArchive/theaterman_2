...
//  ------------------------------------------------------------------------ //
  ...
  switch ($theaterman->config['start page']) {
    case 'location':
      $_POST['id'] = $theaterman->config['start id'];
      $theaterman_frontend->list_bylocation();
      break;
    case 'season':
      $_POST['id'] = $theaterman->config['start id'];
      $theaterman_frontend->list_byseason();
      break;
    case 'all':
      $theaterman_frontend->list_all();
      break;
  }
